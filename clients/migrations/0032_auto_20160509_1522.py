...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('clients', '0031_biomechanical_signature_date'),
    ]

    operations = [
        migrations.CreateModel(
            name='BiomechanicalGait',
            fields=[
                ...
                ('extrinsic_forefoot_post_34_length_l', models.CharField(max_length=5, blank=True, verbose_name='Extrinsic forefoot post (3/4 length) L')),
                ('extrinsic_forefoot_post_34_length_r', models.CharField(max_length=5, blank=True, verbose_name='Extrinsic forefoot post (3/4 length) R')),
                ...
                ('extrinsic_forefoot_post_sulcus_length_l', models.CharField(max_length=5, blank=True, verbose_name='Extrinsic forefoot post (sulcus length) L')),
                ('extrinsic_forefoot_post_sulcus_length_r', models.CharField(max_length=5, blank=True, verbose_name='Extrinsic forefoot post (sulcus length) R')),
                ...
                ('other_topcover', models.CharField(max_length=16, blank=True, verbose_name='Other topcover (please specify)')),
