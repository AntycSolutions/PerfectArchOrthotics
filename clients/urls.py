...
insurance_patterns = patterns(
    '',
    url(r'^$',
        login_required(views.insuranceView),
        name='insurance'),
...
urlpatterns = patterns(
    ...
    # url(r'^pdftest.pdf$',
    #     login_required(views.HelloPDFView.as_view()),
    #     name='pdf'),
    # url(r'^pdftest2.pdf$',
    #    login_required(views.invoice_view),
    #    name='invoice'),
    # url(r'^pdftest3.pdf$',
    #    login_required(views.insurance_letter),
    #     name='insurance_letter'),
    # url(r'^pdftest4.pdf$',
    #    login_required(views.proof_of_manufacturing),
    #    name='proof'),
