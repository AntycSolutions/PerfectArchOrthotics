...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InsuranceClaim'
        db.create_table(u'clients_insuranceclaim', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('claim', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.Claim'])),
            ('coverageType', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.CoverageType'])),
            ('amountClaimed', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
        ))
        db.send_create_signal(u'clients', ['InsuranceClaim'])


    def backwards(self, orm):
        # Deleting model 'InsuranceClaim'
        db.delete_table(u'clients_insuranceclaim')
